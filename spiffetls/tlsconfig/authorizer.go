...
// prefix or a path with the prefix on a segment boundary. The prefix must have
// a non-empty path or this function panics. Use AuthorizeMemberOf to authorize
// any ID in a trust domain.
